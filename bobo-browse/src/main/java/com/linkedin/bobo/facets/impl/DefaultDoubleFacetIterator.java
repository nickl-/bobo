...
public class DefaultDoubleFacetIterator extends DoubleFacetIterator
{
   ...
   * (non-Javadoc)
   * 
   * @see com.linkedin.bobo.api.FacetIterator#getFacet()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.linkedin.bobo.api.FacetIterator#getFacetCount()
   */
  ...
  /* (non-Javadoc)
   * @see com.linkedin.bobo.api.DoubleFacetIterator#nextDouble()
   */
  ...
  /* (non-Javadoc)
   * @see com.linkedin.bobo.api.DoubleFacetIterator#nextDouble(int)
   */
