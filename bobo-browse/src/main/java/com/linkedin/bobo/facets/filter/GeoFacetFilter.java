...
import com.linkedin.bobo.facets.impl.GeoFacetHandler.GeoFacetData;
import com.linkedin.bobo.util.BigFloatArray;
import com.linkedin.bobo.util.GeoMatchUtil;
...
public class GeoFacetFilter extends RandomAccessFilter{
	...
	/* (non-Javadoc)
	 * @see com.linkedin.bobo.facets.filter.RandomAccessFilter#getRandomAccessDocIdSet(com.linkedin.bobo.api.BoboIndexReader)
	 */
	@Override
